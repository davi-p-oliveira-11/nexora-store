...
import type { AdminProduct } from "../hooks/useAdminProductPage.js";
...
type AdminProductFormProps = {
  initial?: AdminProduct | null | undefined;
  saving: boolean;
  error: string | null;
  getToken: () => Promise<string | null>;
  onCancel: () => void;
  onSubmit: (body: Partial<Product> | ProductForm) => void;
};

export function AdminProductForm({ initial, saving, error, getToken, onCancel, onSubmit }: AdminProductFormProps) {
 ...
 const [imageKitFileId, setImageKitFileId] = useState<string>(
